...
router.post("/", verifyToken, async (req, res) => {
  try {
    const { emri, mbiemri, email, telefoni, adresa, qyteti, shteti, subtotal, shipping, total, items } = req.body;
    ...
    const orderRes = await pool.request()
      ...
      .query(`
        INSERT INTO Orders (user_id,emri,mbiemri,email,telefoni,adresa,qyteti,shteti,subtotal,shipping,total)
        OUTPUT INSERTED.id
        VALUES (@user_id,@emri,@mbiemri,@email,@telefoni,@adresa,@qyteti,@shteti,@subtotal,@shipping,@total)
      `);

...
const navLinks = [
  ...
  { section: "Menaxhim",  items: [{ label: "Lojtarët",     path: "/players",   badge: 6  },
                                   ...
                                   { label: "Ndeshjet",     path: "/matches",   badge: 5  },
            ...
            <div className="right-col">
              ...
              <div className="panel">
                <div className="panel-header">
                  ...
                  <div className="panel-action" onClick={() => navigate("/matches")}>Shiko →</div>
                </div>
          ...
          <div className="grid2">
            <div className="panel">
              <div className="panel-header">
                ...
                <div className="panel-action" onClick={() => navigate("/matches")}>Të gjitha →</div>
              </div>
              <div style={{ padding: "4px 18px" }}>
                {matches.map(m => {
